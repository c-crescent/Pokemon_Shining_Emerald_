const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 42, SPECIES_BLISSEY}},
    ...
    [SPECIES_TYROGUE]    = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_HITMONLEE},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_HITMONCHAN},
    ...
    [SPECIES_BAGON]      = {{EVO_LEVEL, 24, SPECIES_SHELGON}},
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 48, SPECIES_SALAMENCE}},
    [SPECIES_BELDUM]     = {{EVO_LEVEL, 24, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_LEVEL, 48, SPECIES_METAGROSS}},
};
